...
project = u'LeXtudio Support'
copyright = u'2018, LeXtudio'
author = u'LeXtudio'
...
if not on_rtd:
    edit_on_github_project = 'lextudio/support'
...
def setup(app):
    ...
    if not on_rtd:
        ...
        """
        app.add_javascript("https://www.googletagmanager.com/gtag/js?id=UA-1962620-19")
